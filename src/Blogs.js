...
<button type="button" className="text-base font-semibold leading-7 text-indigo-600" onClick={() =>setColor('red')}>Red</button>
<button type="button" className="text-base font-semibold leading-7 text-indigo-600" onClick={() =>setColor('pink')}>Pink</button>
